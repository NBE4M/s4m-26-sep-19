...
return [
    ...
    */
    ...
    'bucket' => env('GOOGLE_CLOUD_STORAGE_BUCKET', 'test-media-files'),
    'path_prefix' => env('GOOGLE_CLOUD_STORAGE_PATH_PREFIX', null), // optional: /default/path/to/apply/in/bucket
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/test-media-files/'), // see: Public URLs below
],
...
'album' => [
    ...
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/test-media-files/album'),
],
...
'rss' => [
    ...
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/test-media-files/rss'),
],
'newsletter' => [
    'driver' => 'gcs',
    'project_id' => env('GOOGLE_CLOUD_PROJECT_ID', 'smiling-destiny-184908'),
    ...
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/test-media-files/newsletter'),
],
'files' => [
    'driver' => 'gcs',
    'project_id' => env('GOOGLE_CLOUD_PROJECT_ID', 'smiling-destiny-184908'),
    'key_file' => env('GOOGLE_CLOUD_KEY_FILE',storage_path('app/analytics/service-account-credentials.json')), // optional: /path/to/service-account.json
    'bucket' => env('GOOGLE_CLOUD_STORAGE_BUCKET', 'test-media-files'),
    'path_prefix' => env('GOOGLE_CLOUD_STORAGE_PATH_PREFIX', 'files'), // optional: /default/path/to/apply/in/bucket
    'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', 'https://storage.googleapis.com/test-media-files/files'),
],
