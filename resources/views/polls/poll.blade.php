...
<div class="main-content">
    ...
    <div class="container-fluid npoll">
                        ...
                        <div class="box-body row-fluid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1" >
                                    ...
                                    {!!Form::label('Hyperlink','Hyperlink to story')!!}
                                ...
                                <div class="col-md-6">
                                {!!Form::text('Hyperlink',$article_data[0]->Hyperlink,['class'=>'form-control input-sm'])!!}
                        
                                    @if ($errors->has('Hyperlink'))

                                        <span class="help-error">

                                            <strong>{{ $errors->first('Hyperlink')}}</strong>
                                ...
                                @else
                                <div class="col-md-6">
                                {!!Form::text('Hyperlink',old('Hyperlink'),['class'=>'form-control input-sm'])!!}
...
$(document).ready(function(){
    ...
    // alert('sssssssssss');
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="form-group"> <div class="col-md-6" style="margin-left:25%"><input class="form-control input-sm" type="text" name="answer[]"/><a href="#" class="remove_field">Remove</a></div></div>'); //add input box
        }
    });
