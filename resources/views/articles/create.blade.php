                    ...
                    $('#publishSubmit').click(doClick);
                                    ...
                                    errorElement: "span",
										...
										if (!$("#fileupload").valid()){
                                            ...
                                            alert("Are you sure to publish this story.");
...
var editor = CKEDITOR.replace( 'maxi' );
  ...
  <!-- Create English Url -->
    <div class="container-fluid ">
      <div class="form-legend" >Upload Files</div>
      <div  class="control-group row-fluid afterFileUpload">
        <div class="span2"></div>
            <div class="span4">
                <label class="control-label " for="title">PDF file</label>
                <div class="controls">
                    <input type="radio" id="pdfFile" value="0" name="pdfFile" >
                    
                </div>
            </div>
            <div class="span2"></div>
            <div class="span4">
                <label class="control-label " for="title">Video file</label>
                <div class="controls">
                    <input type="radio" id="videoFile" value="1" name="pdfFile" >
...
<div id="myModal1" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    {{ csrf_field() }}
        ...
        <!-- <button onclick="pdfFileUpload()">Upload</button> -->
      </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button onclick="videoFileUpload()">Upload</button>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
...
<style type="text/css">
 ...
 <script>
$(document).ready(function() {
  $("input[name$='pdfFile']").click(function() {
