  ...
  @else	
	...
	<div class="modal fade right pol" id="sideModalTR" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<hr>
          ...
          @endif
          <span id="poll_success_msg" style="color: #e20c0c;padding: 19px;text-align: center;font-weight: bold;font-size: 29px;"></span>	
      		</div>
    	</div>
  	</div>
@endif
...
@if (Session::has('successpollmessage'))
<script>
  jQuery(function(){
   jQuery('#modal').click();
});
...
<button type="button" class="btn btn-primary" data-toggle="modal" id="modal" data-target="#basicExampleModal"> 
</button>
<!-- Modal -->
<div class="modal fade" id="basicExampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
 aria-hidden="true">
 <div class="modal-dialog" role="document">
   <div class="modal-content" style="margin: auto;box-shadow: 0px 4px 16px;border-radius: 10px;width: 292px;">
     <div class="modal-header bg-danger rounded">
       <h5 class="modal-title text-white" id="exampleModalLabel"><strong>Message</strong></h5>
       <button type="button" class="close" data-dismiss="modal" aria-label="Close">
         <span aria-hidden="true">&times;</span>
       </button>
     </div>
     <div class="modal-body text-center">
       {{Session::get('successpollmessage')}}
     </div>
     <div class="modal-footer">
       <button type="button" class="btn btn-dark mx-auto btn-sm" data-dismiss="modal">Close</button>
