                          ...
                          <table align="center" width="260" border="0">
                            <tbody>
                              <tr>
                                ...
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="https://twitter.com/intent/tweet?url={{ $ArrViewArticle[0]->url }}&utm_source=newsletter&utm_medium=twitter&utm_campaign=twitter&utm_term=twitter&utm_content=twitter"" target="_blank">
...
&source=samachar4media.com&utm_source=newsletter&utm_medium=linkedin&utm_campaign=linkedin&utm_term=linkedin&utm_content=linkedin"" target="_blank">
                                ...
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="https://api.whatsapp.com/send?text={{$ArrViewArticle[0]->title}}  {{$ArrViewArticle[0]->url}}&utm_source=newsletter&utm_medium=whatsapp&utm_campaign=whatsapp&utm_term=whatsapp&utm_content=whatsapp" target="_blank">
                                    <img src="{{url('images/wtsup.jpg')}}" width="25">
                                  </a>
                                </td>
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="mailto:?subject={{$ArrViewArticle[0]->title}}- samachar4media&body=Hi,%0A
                          ...
                          <table align="left" cellpadding="4" width="250" border="0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="https://twitter.com/intent/tweet?url={{ $ArrViewArticle[1]->url }}&utm_source=newsletter&utm_medium=twitter&utm_campaign=twitter&utm_term=twitter&utm_content=twitter"" target="_blank">
                                    <img src="{{url('images/tw.jpg')}}" width="25">
                                  </a>
                                </td>
                                <td align="center" valign="middle" style="line-height: 0">
...
&source=samachar4media.com&utm_source=newsletter&utm_medium=linkedin&utm_campaign=linkedin&utm_term=linkedin&utm_content=linkedin"" target="_blank">
                                ...
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="https://api.whatsapp.com/send?text={{$ArrViewArticle[1]->title}}  {{$ArrViewArticle[1]->url}}&utm_source=newsletter&utm_medium=whatsapp&utm_campaign=whatsapp&utm_term=whatsapp&utm_content=whatsapp" target="_blank">
                                    <img src="{{url('images/wtsup.jpg')}}" width="25">
                                  </a>
                                </td>
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="mailto:?subject={{$ArrViewArticle[1]->title}}- samachar4media&body=Hi,%0A
 I thought you'd like this:%0A%0A
                          ...
                          <table align="right" cellpadding="4" width="250" border="0">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="https://twitter.com/intent/tweet?url={{ $ArrViewArticle[2]->url }}&utm_source=newsletter&utm_medium=twitter&utm_campaign=twitter&utm_term=twitter&utm_content=twitter"" target="_blank">
                                    <img src="{{url('images/tw.jpg')}}" width="25">
                                  </a>
                                </td>
                                <td align="center" valign="middle" style="line-height: 0">
...
&source=samachar4media.com&utm_source=newsletter&utm_medium=linkedin&utm_campaign=linkedin&utm_term=linkedin&utm_content=linkedin"" target="_blank">
                                ...
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="https://api.whatsapp.com/send?text={{$ArrViewArticle[2]->title}}  {{$ArrViewArticle[2]->url}}&utm_source=newsletter&utm_medium=whatsapp&utm_campaign=whatsapp&utm_term=whatsapp&utm_content=whatsapp" target="_blank">
                                    <img src="{{url('images/wtsup.jpg')}}" width="25">
                                  </a>
                                </td>
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="mailto:?subject={{$ArrViewArticle[2]->title}}- samachar4media&body=Hi,%0A
 I thought you'd like this:%0A%0A
                  ...
                  <table align="left" width="190" border="0">
                    <tbody>
                      <tr>
                                ...
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="https://twitter.com/intent/tweet?url={{ $ArrViewArticle[$ava]->url }}&utm_source=newsletter&utm_medium=twitter&utm_campaign=twitter&utm_term=twitter&utm_content=twitter"" target="_blank">
                                    <img src="{{url('images/tw.jpg')}}" width="25">
                                  </a>
                                </td>
                                <td align="center" valign="middle" style="line-height: 0">
...
&title={{$ArrViewArticle[$ava]->title}}
...
&source=samachar4media.com&utm_source=newsletter&utm_medium=linkedin&utm_campaign=linkedin&utm_term=linkedin&utm_content=linkedin"" target="_blank">
                                ...
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="https://api.whatsapp.com/send?text={{$ArrViewArticle[$ava]->title}}  {{$ArrViewArticle[$ava]->url}}&utm_source=newsletter&utm_medium=whatsapp&utm_campaign=whatsapp&utm_term=whatsapp&utm_content=whatsapp" target="_blank">
                                    <img src="{{url('images/wtsup.jpg')}}" width="25">
                                  </a>
                                </td>
                                <td align="center" valign="middle" style="line-height: 0">
                                  <a href="mailto:?subject={{$ArrViewArticle[$ava]->title}}- samachar4media&body=Hi,%0A
 I thought you'd like this:%0A%0A
              ...
              <tr>
                <td align="center" valign="middle" style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-size: 14px;">
                  <strong>If you're having trouble viewing this email, please 
                    <a href="{{Config::get('constants.storagepath').'newsletter/evening-post-'.date('d-m-Y').'.html'}}" target="_blank" style="color: #3796b5; text-decoration: none;">click here
                    </a>.
                  </strong>
                </td>
              </tr>
