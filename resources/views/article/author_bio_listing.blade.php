            ...
            <div class="row mt-4">
                <div class="col-lg-7">
                    <div class="row"> 
                        ...
                        <img class="img-fluid img-thumbnail rounded-circle" src="{{Config::get('constants.storagepath')}}{{$authorbio->photo}}" width="100%" alt="{{$authorbio->name}}" onerror="this.onerror=null;this.src='{{asset("images/s4m-staff.png")}}';">
