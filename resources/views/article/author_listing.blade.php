            ...
            @foreach($ArrAuthorListing as $authList)
              <div class="author-person"> 
                <a href="{{url('author/'.str_replace(' ','-',$authList->name).'-'.$authList->author_id)}}">
                  <img src="{{Config::get('constants.storagepath')}}{{$authList->photo}}" width="100%" alt="{{$authList->name}}" onerror="this.onerror=null;this.src='{{asset("images/default_profile_photo.png")}}';">
                </a>
                <h6 class="mt-2">
